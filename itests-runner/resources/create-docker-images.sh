...
curl -I http://cloudify-tests-files.s3.amazonaws.com/docl-images/docl-manager.tar.gz | grep 200
...
if [ "$exit_code" -eq "0" ]; then
    ...
    set -e
    curl -O http://cloudify-tests-files.s3.amazonaws.com/docl-images/docl-manager.tar.gz
